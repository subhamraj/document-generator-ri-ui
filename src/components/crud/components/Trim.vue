<template>
	<v-dialog v-model="dialog" max-width="500px">
		...
		<!-- Activator -->
		<v-icon small class="mr-3" slot="activator">delete</v-icon>
		...
		<v-card>
			...
			<!-- Dialog Header -->
			<v-card-title>
				<h3 class="headline red--text">Sure you want to delete this row?</h3>
			</v-card-title>
			...
			<v-card-actions>
				...
				<v-btn color="red lighten-1" flat @click="confirmTrim">Delete</v-btn>
			</v-card-actions>
